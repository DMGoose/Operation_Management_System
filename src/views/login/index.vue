    ...
    <div class="login_container">
       <el-row>
            ...
            <el-col :span="12" :xs="24">
                <el-form class="login_form" :model="loginForm" :rules="rules" ref="el_form_component">
                    <h1>Hej!</h1>
                    ...
                    <el-form-item >
                        <el-button :loading="loading" class="login_btn" type="primary" size="default" @click="login">Login in</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
       </el-row>
