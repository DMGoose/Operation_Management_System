<template>
    ...
    <el-popover placement="bottom" title="Theme Setting" :width="200" trigger="hover">
        <!-- 表单组件 -->
        <el-form>
            ...
            <el-form-item label="Dark Mode">
                <!-- 暗黑模式按钮 -->
                <el-switch @change="changeDark" v-model="dark" class="mt-2" style="margin-left: 24px" inline-prompt active-icon="Moon"
    ...
    <img :src="userStore.avatar" style="width:30px; height:30px; margin:0px 13px; border-radius:50%">
    <!-- 下拉菜单 -->
